...
Feature 005.10 submits this prompt through knowledge-ask. No token estimator,
configurable template, conversation integration, or model-specific formatting exists.
