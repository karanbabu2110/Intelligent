 ...
 * identifiers and bounded ordered message histories; it is not yet connected to the
 * foreground session. The package does not restore sessions, initialize production
 * schema, trim, summarize, or estimate provider tokens.</p>
 */
