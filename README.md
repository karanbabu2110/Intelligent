...
- Active epic: [Epic 006 — First Memory Capability](https://github.com/karanbabu2110/KAOS/issues/10); [Feature 006.08 — Memory Privacy Controls](https://github.com/karanbabu2110/KAOS/issues/879) exposes a content-free privacy report for the fixed local `answer-detail` memory
