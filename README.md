...
- Active epic: [Epic 009 — First Agent Workflow](https://github.com/karanbabu2110/KAOS/issues/53); current feature: [009.06 — User Approval Checkpoints](https://github.com/karanbabu2110/KAOS/issues/905)
...
[execution state](docs/evolution/agent-execution-state.md). The current ordered
work is
